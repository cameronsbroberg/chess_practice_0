...
public class ChessBoard {
    ...
    public void resetBoard() {
        ...
        for (int j = 0; j < 8; j++) {
            this.addPiece(new ChessPosition(2,j + 1),new ChessPiece(ChessGame.TeamColor.WHITE, ChessPiece.PieceType.PAWN));
            this.addPiece(new ChessPosition(7,j + 1),new ChessPiece(ChessGame.TeamColor.BLACK, ChessPiece.PieceType.PAWN));
        }
